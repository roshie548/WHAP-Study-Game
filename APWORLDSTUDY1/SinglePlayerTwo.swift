...
var questionArrayTwo: [QuestionObj] = []

class SinglePlayerTwo: UIViewController, ADBannerViewDelegate {

    override func viewDidLoad() {
        super.viewDidLoad()
        RandomQuestions(array: questionArrayTwo)
    }
    
    func parseJson() {
        let jsonURLString = "https://whap-db.herokuapp.com/?q=TimePeriodTwo"
        ...
        URLSession.shared.dataTask(with: url) { (data, response, err) in
            ...
            do {
                ...
                for question in model {
                    questionArrayTwo.append(question)
                }
                
                for question in questionArrayTwo {
                    print(question.qID)
                }
    ...
    func RandomQuestions(array: [QuestionObj]){
        ...
        questionboxtwo.setTitle(array[RandomNumber].Question, for: UIControlState())
