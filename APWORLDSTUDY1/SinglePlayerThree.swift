...
var questionArrayThree: [QuestionObj] = []

class SinglePlayerThree: UIViewController, ADBannerViewDelegate {
    
    override func viewDidLoad() {
        super.viewDidLoad()
        RandomQuestions(array: questionArrayThree)
    }
    ...
    func parseJson() {
        let jsonURLString = "https://whap-db.herokuapp.com/?q=TimePeriodThree"
        ...
        URLSession.shared.dataTask(with: url) { (data, response, err) in
            ...
            do {
                ...
                for question in model {
                    questionArrayThree.append(question)
                }
                
                for question in questionArrayThree {
                    print(question.qID)
                }
