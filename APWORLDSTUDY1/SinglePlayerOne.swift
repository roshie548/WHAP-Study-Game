...
var questionArrayOne: [QuestionObj] = []
...
//        RandomQuestions()
        RandomQuestions(array: questionArrayOne)
}
    
    func parseJson() {
        let jsonURLString = "https://whap-db.herokuapp.com/?q=TimePeriodOne"
        ...
        URLSession.shared.dataTask(with: url) { (data, response, err) in
            ...
            do {
                ...
                for question in model {
                    questionArrayOne.append(question)
                }
                
                for question in questionArrayOne {
                    print(question.qID)
                }
